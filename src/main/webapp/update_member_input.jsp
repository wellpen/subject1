...
<%
MemberupdateVO memberupdateVO = (MemberupdateVO) request.getAttribute("memberupdateVO"); //EmpServlet.java (Concroller) 存入req的empVO物件 (包括幫忙取出的empVO, 也包括輸入資料錯誤時的empVO物件)
%>
	...
	<header class="header">
		...
		<div class="humberger__menu__wrapper">
			<div class="humberger__menu__logo">
				<a href="#"><img src="/memberupdatehtml/img/Frame6.svg" alt="" /></a>
				<!--自然改-->
			</div>
						...
						<div class="tab-pane fade show active" id="nav-home"
							...
							<FORM METHOD="post" ACTION="member.do" name="form1">
								<table>
									<tr>
										<td
											style="color: white; background-color: rgb(127, 173, 57); width: 100px;">會員編號:<font
											color=red><b>*</b></font></td>
										<td><%=memberupdateVO.getMemberserialnumber()%></td>
									</tr>
									<tr>
										<td
											style="color: white; background-color: rgb(127, 173, 57); width: 100px;">會員姓名:</td>
										<td><input type="TEXT" name="name" size="40"
											value="<%=memberupdateVO.getName()%>" /></td>
									</tr>
									<tr>
										<td
											style="color: white; background-color: rgb(127, 173, 57); width: 100px;">會員地址:</td>
										<td><input type="TEXT" name="address" size="40"
											value="<%=memberupdateVO.getAddress()%>" /></td>
									</tr>
									<tr>
										<td
											style="color: white; background-color: rgb(127, 173, 57); width: 100px;">會員Email:</td>
										<td><input type="TEXT" name="email" size="40"
											value="<%=memberupdateVO.getEmail()%>" /></td>
									</tr>
									<tr>
										<td
											style="color: white; background-color: rgb(127, 173, 57); width: 100px;">會員電話</td>
										<td><input type="TEXT" name="phone" size="40"
											value="<%=memberupdateVO.getPhone()%>" /></td>
									</tr>


								</table>
								<br> <input type="hidden" name="action" value="update">
								<input type="hidden" name="memberserialnumber"
									value="<%=memberupdateVO.getMemberserialnumber()%>"> <input
