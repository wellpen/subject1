...
<%
MemberupdateVO memberupdateVO = (MemberupdateVO) request.getAttribute("memberupdateVO");
%>
					...
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							<a class="nav-item nav-link active" id="nav-home-tab"
								...
								aria-controls="nav-home" aria-selected="true">會員資料新增</a>
						</div>
					</nav>
							...
							<c:if test="${not empty errorMsgs}">
								...
								<ul>
									<c:forEach var="message" items="${errorMsgs}">
										<li style="colosr: red">${message}</li>
									</c:forEach>
								</ul>
							</c:if>
