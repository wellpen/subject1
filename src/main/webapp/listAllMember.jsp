...
List<MemberupdateVO> list = memberupdateService.getAll();
				...
				<div class="col-lg-9">
					<nav>
						<div class="nav nav-tabs" id="nav-tab" role="tablist">
							<a class="nav-item nav-link active" id="nav-home-tab"
								...
								aria-controls="nav-home" aria-selected="true">會員資料</a>
						</div>
					</nav>
					<div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade show active" id="nav-home"
							...
							<br>
							<table>
								<tr style="color: white; background-color: rgb(127, 173, 57)">
								...
								<c:forEach var="memberupdateVO" items="${list}">

									<tr>
										<td>${memberupdateVO.memberserialnumber}</td>
										<td>${memberupdateVO.name}</td>
										<td>${memberupdateVO.address}</td>
										<td>${memberupdateVO.email}</td>
										<td>${memberupdateVO.phone}</td>
										<td>
											<FORM METHOD="post"
												...
												<input type="submit" value="修改"> <input
													...
													value="${memberupdateVO.memberserialnumber}"> <input
